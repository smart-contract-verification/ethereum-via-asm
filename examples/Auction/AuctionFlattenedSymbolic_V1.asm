...
definitions:
	...
	// la funzione destroy può venir chiamata solamente dall'owner del contratto - S_2
	...
	// se viene fatta una chiamata alla funzione destroy, tutti i soldi del contratto vanno all'owner S_2
