...
definitions:
	...
	// non viene alzata una eccezione anche se viene fatta una chiamata a deposit e il balance di state_dao è maggiore di 12 - S_4
	...
	// il balance di state_dao è sempre minore o uguale a 12 - S_20
